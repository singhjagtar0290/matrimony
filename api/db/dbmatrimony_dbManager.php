...
function getConnection() {
	...
	global $db_matrimony_db_Url, $db_matrimony_db_User, $db_matrimony_db_Pass, $db_matrimony_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_matrimony_db_Url.";dbname=".$db_matrimony_db_DbName, $db_matrimony_db_User, $db_matrimony_db_Pass);
